...
corners[0,0,:] = [-0.01,0.,0.049]
corners[0,1,:] = [-0.01,0.2,0.049]
corners[0,2,:] = [-0.01,0.,0.34]
corners[0,3,:] = [-0.01,0.2,0.34]
corners[0,4,:] = [0.1,0.,0.049]
corners[0,5,:] = [0.1,0.2,0.049]
corners[0,6,:] = [0.1,0.,0.34]
corners[0,7,:] = [0.1,0.2,0.34]

corners[1,0,:] = [0.1,0.,0.049]
corners[1,1,:] = [0.1,0.2,0.049]
corners[1,2,:] = [0.1,0.,0.34]
corners[1,3,:] = [0.1,0.2,0.34]
corners[1,4,:] = [0.862,0.,0.049]
corners[1,5,:] = [0.862,0.2,0.049]
corners[1,6,:] = [0.862,0.,0.34]
corners[1,7,:] = [0.862,0.2,0.34]

corners[2,0,:] = [0.862,0.,0.049]
corners[2,1,:] = [0.862,0.2,0.049]
corners[2,2,:] = [0.862,0.,0.34]
corners[2,3,:] = [0.862,0.2,0.34]
corners[2,4,:] = [1.05,0.,0.049]
corners[2,5,:] = [1.05,0.2,0.049]
corners[2,6,:] = [1.05,0.,0.21]
